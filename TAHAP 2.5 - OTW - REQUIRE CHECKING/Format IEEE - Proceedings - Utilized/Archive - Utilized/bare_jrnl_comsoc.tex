...
\title{Water quality assessment of Lake Toba using extreme learning machine}
%
%
...
\author{
	\IEEEauthorblockN{Eric~Suwarno, Romi~Fadillah~Rahmat, Maya~Silvi~Lydia}
	\\
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\columnwidth, height=30mm]{fig-4.jpg}
